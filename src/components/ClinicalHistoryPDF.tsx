...
const styles = StyleSheet.create({
  ...
  header: { marginBottom: 15, borderBottomWidth: 1, borderBottomColor: '#172B4D', paddingBottom: 10 },
  title: { fontSize: 16, fontWeight: 'bold', textAlign: 'center', marginBottom: 5, color: '#172B4D' },
  subtitle: { fontSize: 10, textAlign: 'center', color: '#6B778C' },
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <Text style={styles.title}>HISTORIAL CLÍNICO COMPLETO</Text>
